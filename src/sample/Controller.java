...
public class Controller {
	...
	public Button REP = new Button(); //da aggiungere nell'intefaccia grafica
	...
	{
		System.out.println("nella funzione di loop");
		
		if(player.getStatus().equals(REP))
		{
			loop.loop_state = true;
			loop.songs = pl.nSongs();

			System.out.println("nella funzione di loop sono presenti "+ loop.songs + " canzoni");
